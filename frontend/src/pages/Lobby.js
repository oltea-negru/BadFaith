                                ...
                                <div>
                                    {
                                        codeCreated === ''
                                            ...
                                            <div className='flex flex-col text-center place-items-center h-[600px] w-[500px] bg-[#1880bb] border-4 border-black justify-between'>
                                                ...
                                                <button className='font-another custom-transition border-black border-y-4 bg-white mb-10 h-14 text-3xl hover:text-4xl text-black active:text-4xl w-full focus:outline-none' onClick={() => { dispatch(createLobby({playerID: email, nickname}))}}>Create Code</button>
                                            </div> :
